...
public class TraineeTrainingSpecification {
    ...
    public static Specification<Training> findByCriteria(@NotNull String username,
        ...
        return Specification.where(traineePredicate(username))
                .and(dateRangePredicate(from, to))
                .and(trainerNamePredicate(trainerName))
                .and(trainingTypePredicate(trainingType));
    }

    private static Specification<Training> traineePredicate(String username) {
