...
import static com.crm.gym.app.util.Constants.DEBUG_PARSER_EXCEPTION;
import static com.crm.gym.app.util.Constants.DEBUG_PARSER_INPUT;
import static com.crm.gym.app.util.Constants.DEBUG_PARSER_RESULT;
import static com.crm.gym.app.util.Constants.INFO_PARSER_EXCEPTION;
import static com.crm.gym.app.util.Constants.INFO_PARSER_INPUT;
import static com.crm.gym.app.util.Constants.INFO_PARSER_RESULT;
...
public class ParserLoggingAspect extends BaseLoggingAspect {
    ...
    @Autowired
    public ParserLoggingAspect(MessageUtils messageUtils) {
        super(messageUtils);
    }
