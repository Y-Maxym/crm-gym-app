...
import static com.crm.gym.app.util.LoggingConstants.DEBUG_USER_UTILS_EXCEPTION;
import static com.crm.gym.app.util.LoggingConstants.DEBUG_USER_UTILS_INPUT;
import static com.crm.gym.app.util.LoggingConstants.DEBUG_USER_UTILS_RESULT;
import static com.crm.gym.app.util.LoggingConstants.INFO_USER_UTILS_EXCEPTION;
import static com.crm.gym.app.util.LoggingConstants.INFO_USER_UTILS_INPUT;
import static com.crm.gym.app.util.LoggingConstants.INFO_USER_UTILS_RESULT;
...
public class UserUtilsLoggingAspect extends BaseLoggingAspect {
    ...
    @Autowired
    public UserUtilsLoggingAspect(LoggingMessageUtils messageUtils) {
        super(messageUtils);
    }
